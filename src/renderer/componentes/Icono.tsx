// Íconos de línea (24x24, trazo 2) dibujados a mano para no depender de una librería externa.
...
const TRAZOS = {
  ...
  flechaDerecha: <path d="m9 18 6-6-6-6" />,
  flechaIzquierda: <path d="m15 18-6-6 6-6" />,
  auto: (
    <>
      <path d="M5 17h14M6.5 17v2a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-2M20.5 17v2a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-2" />
      <path d="M3 17v-4.2a2 2 0 0 1 .2-.9l2-4A2 2 0 0 1 7 6.8h10a2 2 0 0 1 1.8 1.1l2 4a2 2 0 0 1 .2.9V17z" />
  ...
  // Los cuatro de las llamadas de voz (14.0): llamar, cortar, y el micrófono prendido y apagado.
  telefono: (
  ...
  telefonoCortado: (
    <>
      ...
      <path d="M8.01 9.99a19.79 19.79 0 0 1-3.07-8.63" />
      <path d="M5.06 2h2.05a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11" />
      <path d="m2 2 20 20" />
    </>
  ),
  microfono: (
  ...
  luna: <path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79" />,
...
export function Icono({ nombre, tamano = 18, className, ...resto }: PropsIcono) {
  return (
    <svg
      width={tamano}
      height={tamano}

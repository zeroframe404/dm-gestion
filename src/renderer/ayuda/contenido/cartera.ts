    ...
    secciones: [
      ...
      },
      {
        ...
        parrafos: [
          ...
          'Las tarjetas de arriba (Total, Vencen hoy, Vencidos, Vencidos avisados, Avisados hoy, Se les termina la cobertura, Pagados hoy) son contadores del día: se actualizan solos con lo que va pasando. Además funcionan como filtro: tocá una y la tabla queda sólo con esas filas; tocala de nuevo (o tocá Total) para volver a ver el mes entero. Los números siguen contando sobre todo el mes aunque haya un filtro puesto.',
          '«Vencidos» y «Vencidos avisados» son la misma deuda vencida dividida en dos: la primera junta a los que todavía no se les mandó ningún aviso, y en cuanto se les avisa —con el botón «Avisar» o marcándolos «Avisado» a mano— la fila se pasa sola a «Vencidos avisados». Así se distingue de un vistazo a quién ya se le avisó de a quién todavía no.',
        ],
      },
      {

  ...
  multicotizador: {
    ...
    secciones: [
      ...
      },
      {
        ...
        lista: [
          'El vehículo, elegido del catálogo de la agencia (Administración → Catálogo de vehículos). Si el catálogo es el de InfoAuto, las compañías lo reconocen por su código, que es exacto. Si se carga a mano, conviene escribir también la versión (por ejemplo «1.6 XEI CVT»): cada compañía lo busca por nombre en su propio catálogo.',

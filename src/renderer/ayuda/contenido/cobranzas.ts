    ...
    secciones: [
      ...
      },
      {
        ...
        parrafos: [
          ...
          '«Observación» es una nota de texto para dejar asentado algo del día del mostrador (por ejemplo, que Dani se llevó tal plata a tal hora, o cualquier aclaración) sin que sea un movimiento de dinero: no pide importe y no cambia ninguna de las cuentas de la caja. Se ve en su propia sección, aparte de los gastos y las bajadas a la caja fuerte, y también se puede sacar si hace falta. Es por sucursal, como todo lo demás de la caja chica: cada mostrador tiene sus propias observaciones.',

...
const api: ApiDm = {
  ...
  cobranzas: {
    ...
    guardarMovimientoCaja: (datos) => invocar('cobranzas:guardarMovimientoCaja', datos),
  ...
  mensajes: {
    ...
    contactos: () => invocar('mensajes:contactos'),
    abrirCon: (clave) => invocar('mensajes:abrirCon', clave),
    ...
    borrar: (mensajeId) => invocar('mensajes:borrar', mensajeId),
    abrirAdjunto: (adjuntoId) => invocar('mensajes:abrirAdjunto', adjuntoId),
    contenidoDeAdjunto: (adjuntoId) => invocar('mensajes:contenidoDeAdjunto', adjuntoId),
    borrarAdjunto: (adjuntoId) => invocar('mensajes:borrarAdjunto', adjuntoId),
    estado: () => invocar('mensajes:estado'),
  ...
  vehiculos: {
    ...
    actualizar: () => invocar('vehiculos:actualizar'),
    importaciones: () => invocar('vehiculos:importaciones'),
    importarAhora: (forzar) => invocar('vehiculos:importarAhora', forzar),
  ...
  galeno: {
    ...
    borrarCredenciales: () => invocar('galeno:borrarCredenciales'),
    probar: () => invocar('galeno:probar'),
    planesComerciales: (tipoVehiculo) => invocar('galeno:planesComerciales', tipoVehiculo),
    marcas: (tipoVehiculo) => invocar('galeno:marcas', tipoVehiculo),
    modelos: (marcaCodigo) => invocar('galeno:modelos', marcaCodigo),
    anios: (marcaCodigo, modeloCodigo) => invocar('galeno:anios', marcaCodigo, modeloCodigo),
    subModelos: (marcaCodigo, modeloCodigo, anio) => invocar('galeno:subModelos', marcaCodigo, modeloCodigo, anio),
    tiposDePersona: () => invocar('galeno:tiposDePersona'),
    codigoPostal: (tipoVehiculo, codigoPostal) => invocar('galeno:codigoPostal', tipoVehiculo, codigoPostal),
    modosDeFacturacion: (tipoVehiculo, planComercialCodigo) => invocar('galeno:modosDeFacturacion', tipoVehiculo, planComercialCodigo),
    condicionesDePago: (tipoVehiculo, modoFacturacionCodigo) => invocar('galeno:condicionesDePago', tipoVehiculo, modoFacturacionCodigo),
    formasDePago: (tipoVehiculo, modoFacturacionCodigo, planComercialCodigo) =>
      invocar('galeno:formasDePago', tipoVehiculo, modoFacturacionCodigo, planComercialCodigo),
    equipoGnc: () => invocar('galeno:equipoGnc'),
    equiposDeRastreo: () => invocar('galeno:equiposDeRastreo'),
    clausulasDeAjuste: () => invocar('galeno:clausulasDeAjuste'),
    accesorios: () => invocar('galeno:accesorios'),
    categoriasIva: () => invocar('galeno:categoriasIva'),
    codigosIIBB: () => invocar('galeno:codigosIIBB'),
    tiposDeUso: () => invocar('galeno:tiposDeUso'),
    tiposDeDocumento: () => invocar('galeno:tiposDeDocumento'),
    nacionalidades: () => invocar('galeno:nacionalidades'),
    sexos: () => invocar('galeno:sexos'),
    estadosCiviles: () => invocar('galeno:estadosCiviles'),
    bancos: () => invocar('galeno:bancos'),
    tarjetasDeCredito: () => invocar('galeno:tarjetasDeCredito'),
    cotizar: (datos) => invocar('galeno:cotizar', datos),
    emitir: (datos) => invocar('galeno:emitir', datos),
    emitirConInspeccion: (datos) => invocar('galeno:emitirConInspeccion', datos),
    reporte: (tipo, filtros) => invocar('galeno:reporte', tipo, filtros),
    detalleDePoliza: (rama, poliza, nroRiesgo) => invocar('galeno:detalleDePoliza', rama, poliza, nroRiesgo),

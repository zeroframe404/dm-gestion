...
// «DeGalenoNovedades» y no «DeGaleno» a secas: la integración de la API REST de Galeno (cotización,
// emisión, consultas) ya usa `EstadoDeGaleno` y `PruebaDeGaleno` para sus propias credenciales, que no
// tienen nada que ver con el usuario del portal que consulta el VPS. Dos cosas distintas, dos nombres.
export interface EstadoDeGalenoNovedades {
  configurado: boolean
  enCurso: boolean
  pendientes: number
...
export interface PruebaDeGalenoNovedades {
  ok: boolean
  detalle: string
